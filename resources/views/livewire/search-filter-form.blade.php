<div>
    ...
    <div class="flex flex-row p-2">
        ...
        <div  class="p-2">
        <label for="rangeKm" class="block  text-sm text-gray-900 dark:text-white">Distanza <b>{{$selectedKm}}</b>km</label>
        <input id="rangeKm" type="range" wire:change="setKm($event.target.value)" min="0" max="60" value="{{$selectedKm}}" class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer dark:bg-gray-700">
        </div>
        <div>
